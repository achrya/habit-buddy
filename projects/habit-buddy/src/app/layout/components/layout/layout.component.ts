...
import { BottomNavComponent, DialogComponent, HelpOverlayComponent } from '../../../shared';
...
@Component({
  selector: 'app-layout',
  standalone: true,
  imports: [CommonModule, RouterOutlet, SidebarComponent, BottomNavComponent, HeaderComponent, DialogComponent, HelpOverlayComponent, GlobalHelpComponent],
